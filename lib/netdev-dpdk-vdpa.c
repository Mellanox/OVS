                                       ...
                                       struct netdev_custom_stats *custom_stats)
{
    ...
    for (i = 0; i < custom_stats->size; i++) {
        ovs_strlcpy(custom_stats->counters[i].name, stats_names[i],
    ...
    custom_stats->counters[0].value = rte_stats.opackets;
    custom_stats->counters[1].value = rte_stats.obytes;
    ...
    custom_stats->counters[2].value = rte_stats.opackets;
    custom_stats->counters[3].value = rte_stats.obytes;
